    ...
    const fetchData = async () => {
      try {
        const response = await axios.get(
          `https://api.themoviedb.org/3/trending/${contentType}/week?api_key=9c8709e24862b7b00803591402286323&${discover}&language=ko-KR`
        );
...
export default TvTrendingWeekList;
