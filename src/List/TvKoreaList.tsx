...
const TvKoreaList: FC = () => {
  ...
  const discover =
    "include_adult=false&include_null_first_air_dates=false&language=ko-KR&page=1&sort_by=vote_count.desc&with_original_language=ko";

  // 상단 타이틀 제목 변경
  const mainTitle = "한국 인기 시리즈";
    ...
    const fetchData = async () => {
      try {
        const response = await axios.get(
          `https://api.themoviedb.org/3/discover/${contentType}?api_key=9c8709e24862b7b00803591402286323&${discover}`
        );
