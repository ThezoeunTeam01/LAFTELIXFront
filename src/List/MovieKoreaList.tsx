...
const MovieKoreaList: FC = () => {
  ...
  const discover =
    "sort_by=revenue.desc&with_original_language=ko&with_watch_providers=8&without_genres=18";

  // 상단 타이틀 제목 변경
  const mainTitle = "한국 영화";
    ...
    const fetchData = async () => {
      try {
        const response = await axios.get(
          `https://api.themoviedb.org/3/discover/${contentType}?api_key=9c8709e24862b7b00803591402286323&${discover}&language=ko-KR`
        );
