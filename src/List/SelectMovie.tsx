...
function SelectMovie({
  ...
  const fetchData = async () => {
    const response = await call(`/reply?movieId=${movieId}`, "GET");
        ...
        <Modal.Body className="bgColorBk" style={{ padding: `0px` }}>
          {movie && (
            <div className="d-flex">
              ...
              >
                {/* dim 레이어 - 검정막 */}
                <Row className="h-100 dimBg" style={{ zIndex: 3, marginLeft: `0` }}>
                  <Col
                  ...
                  >
                    ...
                    <div className="d-flex align-items-center">
                      <div>
                        ...
                        <div className="d-flex">
                          <button onClick={handlePlayBtnClick2}
                            ref={target}
                  ...
                  <Col
                    ...
                    style={{ marginRight: `30px`, marginTop:`30px`, marginBottom: `30px` }}
                  >
                    {/* 영화 포스터 img */}
                    <img
                      className="rounded"
